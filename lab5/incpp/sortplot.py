...
heap=[0,0,0,0,0.002008,0.003975,0.015224,0.037019]
shell=[0,0,0,0,0.002462,0.004001,0.021124,0.041505]
radix=[0,0,0,0,0,0.001998,0.005,0.009718]
...
plt.plot(n,shell,label="Shell Sort")
